...
This repository is a front-end starter template using [React](https://react.dev/), [Vite](https://vite.dev/), [MUI](https://mui.com/material-ui/?srsltid=AfmBOor8atqstNDKO2OzksylVmtqlECvFemwfAsohhkekSWlAHXt_56b), [Zustand](https://zustand.docs.pmnd.rs/getting-started/introduction), [TypeScript](https://www.typescriptlang.org/), [Zod](https://zod.dev/), and [React-Hook-Form](https://www.react-hook-form.com/). It is designed to help you quickly set up a new project with the best practices and configurations already in place.
