...
This repository is a front-end starter template using [Next.js](https://nextjs.org/), [MUI](https://mui.com/material-ui/?srsltid=AfmBOor8atqstNDKO2OzksylVmtqlECvFemwfAsohhkekSWlAHXt_56b), [TypeScript](https://www.typescriptlang.org/), [Zod](https://zod.dev/), [React-Hook-Form](https://www.react-hook-form.com/), and [Zustand](https://zustand.docs.pmnd.rs/getting-started/introduction). It is designed to help you quickly set up a new project with the best practices and configurations already in place.
